...
public final class HistoryManager: ObservableObject {
    ...
    private init() {
        ...
        let transribDir = appSupport.appendingPathComponent("Transrib", isDirectory: true)

        try? FileManager.default.createDirectory(at: transribDir, withIntermediateDirectories: true, attributes: nil)
        self.fileURL = transribDir.appendingPathComponent("history.json")
